      ...
      <SectionTitle title = {'Projects'} icon_id =
       {
        ...
        <h2>pyparcel</h2><p>pyparcel is the simple and secure way to convert python objects to bytestrings. pyparcel extends the usage of struct and provides a simpler way to pack classes and built-in types. [{generateLink("https://github.com/najaco/pyparcel")}]</p>
